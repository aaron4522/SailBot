...
if c.config["MAIN"]["device"] == "pi":
    ...
    from sailbot.sensors.compass import compass
    from sailbot.sensors import GPS
        #from camera import camera
    from sailbot.sensors.transceiver import arduino
    from sailbot.controls.drivers import driver
    from sailbot.events import Collision_Avoidance, Precision_Navigation, Endurance, Station_Keeping, Search
