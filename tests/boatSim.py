...
def drawBoat():
    ...
    # Sail
    sailAngle = (180 - BOAT.compass.angle) + BOAT.drivers.sail.angle if BOAT.compass.angle < 180 else (
    ...
    white = (255, 255, 255)
    text = font.render(
        F'{"Paused " if not UPDATE else ""} Sail: {BOAT.drivers.sail.angle}, Rudder: {BOAT.drivers.rudder.angle}', True,
        white)
